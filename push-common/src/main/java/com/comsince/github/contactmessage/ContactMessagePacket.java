package com.comsince.github.contactmessage;
 ...
 * @Time 19-2-18 下午2:43
 **/
public class ContactMessagePacket extends PushPacket {
    public ContactMessagePacket(String pushMessage){
    ...
    public ByteBuffer encode() {
        ...
        header.setSignal(Signal.CONTACT);
